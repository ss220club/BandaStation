                          ...
                          >
                            <Stack textAlign="center" fill align="center">
                              <Stack.Item textAlign="center" width="100%">
                                Пустая цель, перекиньте цель чтобы взятся
                                за неё
                              </Stack.Item>
                            </Stack>
                          </Box>
      ...
      <Flex.Item grow={grow} basis="content">
        <Box className="UplinkObjective__Content" height="100%">
          ...
          {finalObjective && objectiveState === ObjectiveState.Inactive && (
            <NoticeBox mt={1}>
              Взятие этой цели заблокирует возможность взять другие
              цели! Также вы не сможете отменить эту
              цель.
            </NoticeBox>
          )}
        </Box>
                        ...
                        <Tooltip
                          content={
                            <Box>
                              ...
                              за эту цель. Это потому что ваш
                              уровень{' '}
