    ...
    <Stack.Item>
      <Stack vertical fontSize="12px">
        ...
        <Stack.Item>
          ...
          <br />
          Эта аура пометит вас, как приверженца ереитческого пути, раскрыв вас для любого
          смотрящего. Подумайте о рисках, прежде чем накапливать слишком много знаний!
          <br />
          Держите в уме, что использование&nbsp;
          <span style={hereticPurple}> кодекса Цикатрикс</span> при поглощении разлома&nbsp;
          <span style={hereticYellow}></span> сделает довольно очевидным, вашу приверженность еретическому пути
        </Stack.Item>
      </Stack>
    </Stack.Item>
  );
