...
/obj/machinery/vending/wardrobe/chap_wardrobe
	...
	products = list(
		...
		/obj/item/clothing/accessory/pocketprotector/cosmetology = 3,
		...
		/obj/item/clothing/suit/chaplainsuit/nun = 10,
		/obj/item/clothing/head/chaplain/nun_hood = 10,
		/obj/item/clothing/suit/chaplainsuit/holidaypriest = 10,
		/obj/item/clothing/suit/hooded/chaplainsuit/monkhabit = 10,
		/obj/item/clothing/head/chaplain/kippah = 10,
		/obj/item/clothing/suit/chaplainsuit/whiterobe = 10,
		/obj/item/clothing/head/chaplain/taqiyah/white = 10,
		/obj/item/clothing/head/chaplain/taqiyah/red = 10,
		/obj/item/clothing/suit/chaplainsuit/monkrobeeast = 10,
		/obj/item/clothing/head/rasta = 10,
		/obj/item/clothing/suit/chaplainsuit/shrinehand = 10,
		/obj/item/storage/backpack/cultpack = 10,
		/obj/item/storage/fancy/candle_box = 2,
		/obj/item/radio/headset/headset_srv = 2,
		/obj/item/clothing/suit/chaplainsuit/habit = 10,
		/obj/item/clothing/head/chaplain/habit_veil = 10,
	...
	contraband = list(
		...
		/obj/item/clothing/head/chaplain/clownmitre = 5,
		/obj/item/clothing/suit/chaplainsuit/clownpriest = 5,
	)
	premium = list(
