...
#undef SURGERY_SPEED_PAIN_MULTIPLIER // BANDASTATION EDIT
#undef SURGERY_LIGHT_AMOUNT_REQUIRED // BANDASTATION EDIT
#undef SURGERY_LIGHT_AMOUNT_MODIFIER // BANDASTATION EDIT
