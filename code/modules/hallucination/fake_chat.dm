...
/datum/hallucination/chat/start()
	...
	var/message = hallucinator.compose_message(speaker, understood_language, chosen, is_radio ? "[FREQ_INTERCOM]" : null, is_radio ? RADIO_CHANNEL_INTERCOM : null, is_radio ? RADIO_COLOR_INTERCOM : null, spans, visible_name = TRUE)
