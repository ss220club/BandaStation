/datum/bounty/item/engineering/emitter
	name = "Эмиттер"
	description = "Мы предполагаем, что в чертежах эмиттеров на вашей станции может быть дефект, так как присутствует через чур огромное количество взрывов суперматерии в вашем секторе. Отправьте нам один из ваших эмиттеров."
