...
/datum/supply_pack/goody/disabler_single
	...
	access_view = ACCESS_WEAPONS
	contains = list(/obj/item/clothing/accessory/holster/energy/disabler)
...
/datum/supply_pack/goody/laser_pistol_single
	...
	access_view = ACCESS_WEAPONS
	contains = list(/obj/item/clothing/accessory/holster/energy/laser_pistol)
...
/datum/supply_pack/goody/thermal_single
	...
	access_view = ACCESS_WEAPONS
	contains = list(/obj/item/clothing/accessory/holster/energy/thermal)
