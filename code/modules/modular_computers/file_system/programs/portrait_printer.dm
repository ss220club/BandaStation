...
/datum/computer_file/program/portrait_printer
	...
	extended_desc = "Эта программа подключается к сайту художественного сообщества Spinward Sector для просмотра и печати произведений искусства, the latter only available on stationary consoles."
