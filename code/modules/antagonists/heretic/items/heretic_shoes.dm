/obj/item/clothing/shoes/greaves_of_the_prophet
	...
	desc = "Сабатоны, сделаные из грубого, изношенного железа. По ощёщениям они более устойчивы, чем земля, по которой они ступают. Их покрывает тонкий слой ржавчины - и всё же при виде их вас охватывает неожиданное чувство покоя."
