...
/datum/heretic_knowledge/curse/corrosion
	...
	desc = "Позволяет трансмутировать кусачки, лужу рвоты и сердце, чтобы наслать проклятие болезни на члена экипажа. \
		Во время действия проклятия жертву будет постоянно рвать, а ее органы будут постоянно получать повреждения. Вы можете усилить проклятие использовав предмет, к которому прикасалась жертва \
		или который покрыт её кровью, чтобы увеличить длительность проклятия."
	gain_text = "Человечесское тело временно. Его разрушение так же неостановимо, как появление ржавчины на металле. Покажи им всё."
