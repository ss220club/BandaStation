/datum/heretic_knowledge_tree_column/moon
	...
	description = list(
		...
		"Выбирайте этот путь, если ты уже имеешь опыт игры на Еретике и хочешь попробовать нечто уникальное, или просто хочешь отыграть пацифиста (Да, именно так!)."
	)
	pros = list(
		"Богатый набор инструментов для запутывания твоих противников.",
		"Сейте хаос на станции при помощи безумцев.",
		"Невосприимчивость к эффектам оглушения при ношении Блестательного Облачения."
	)
	cons = list(
		...
		"Смерть, во время ношения Блестательного Облачения, приведет к крайне кровавому финалу.",
	)
	tips = list(
		"Использование Хватка Мансуса накладывает на цель кратковременные галлюцинации, а так же метку, активируемую вашим Лунным Клинком. Активация метки усмиряет цель, а также вводит её в замешательство(усмирение спадает, если цель получила слишком много урона).",
		...
		"Ваш пассивный навык делают вас полностью невосприимчивыми к повреждениям мозга, а также медленно восстанавливают его здоровье. Обязательно улучшите его, чтобы усилить эффект.",
		"Ваше Блестательное Облачение полностью меняет правила боя для вас и выших противников; Вы становитесь полностью неуязвимы для эффектов оглушения, а все полученные повреждения (смертельные или несмертельные) будут преобразованы в повреждения мозга, однако сама мантия не имеет брони и препятствует использованию стрелкового оружия, пацифицируя вас (вы все ещё можете использовать Лунный Клинок).",
		"Эффекты вашего Лунный Амулет проецируются на Лунный Клинок. При активации, ваш Лунный Клинок больше не будет наносить смертельный урон, он будет наносить урон рассудку и станет неблокируемым, что также позволит вам использовать его в Блестательном Облачении!",
		...
		"Восстание Главарей призывает армию клонов. Они практичесски не наносят урон, но если на них нападут не-еретики, они взорвутся, приводя к потере рассудки и нанесению урона мозгу.",
		"Ваше возвышение даст вам ауру, превращаю близлежащих в верных вам сумасшедших. Однако, если у цели есть имплант защиты разума, то вместо порабощения, через некоторое время их головы просто взорвутся.",
	)
...
/datum/heretic_knowledge/spell/mind_gate
	name = "Врата Разума"
	desc = "Дарует вам Врата Разума, заклинание отнимающее голос, лишающее слуха, зреня, наводящее галюцинации, \
		смятение, лишающее воздуха и наносящее урон мозгу цели в течении 10с.\
...
/datum/heretic_knowledge/moon_amulet
	name = "Лунный Амулет"
	desc = "Позволяет трансмутировать 2 листа стекла, сердце и галстук, чтобы создать Мунный Амулет. \
...
/datum/heretic_knowledge/armor/moon
	desc = "Позволяет преобразовать стол (или костюм), маску и два листа стекла для создания Блестательного Облачения, эта роба сделает носителя невосприимчивым у эффектам оглушения, преобразует все виды повреждений в урон мозгу, а также пацифицируяносителя, лишая его возможности пользоваться дальнобойным оружием (Лунные Клинки обходят пацифизм). \
			Действует как фокусировка пока надета."
...
/datum/heretic_knowledge/spell/moon_parade
	name = "Лунный Парад"
	desc = "Дарует вам Лунный Парад, заклинание - после короткой зарядки, отправляет вперед карнавал \
		при попадании, заставляют цель стать частью парада, накладывая галюцинации."
...
/datum/heretic_knowledge/spell/moon_ringleader
	...
	desc = "Дарует вам Восстание Главарей, заклинание действующиее на область - наносит урон мозгу, пропорционально недостающему значению рассудка у целей, \
			также вызывает галлюцинации, чем меньше рассудка, тем сильнее галюцинации. \
			Если значение их рассудка достаточно низкое, они обезумеют, после чего лишатлся половины имевшегося рассудка."
