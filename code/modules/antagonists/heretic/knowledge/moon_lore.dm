/datum/heretic_knowledge_tree_column/moon
	...
	description = list(
		...
		"Выбирайте этот путь, если у вас уже есть опыт игры на Еретике и хочется попробовать нечто уникальное, или просто хочешь отыграть пацифиста (Да, именно так!)."
	)
	pros = list(
	...
	tips = list(
		...
		"Восстание Главарей призывает армию клонов. Они практически не наносят урон, но если на них нападут не-еретики, они взорвутся, приводя к потере рассудка и нанесению урона мозгу.",
		"Ваше возвышение даст вам ауру, превращающую близлежащих в верных вам сумасшедших. Однако, если у цели есть имплант защиты разума, то вместо порабощения, через некоторое время их головы просто взорвутся.",
	)
...
/datum/heretic_knowledge/spell/moon_ringleader
	...
	desc = "Дарует вам Восстание Главарей, заклинание действующее на область, и наносящее урон мозгу, пропорционально недостающему рассудку у целей, \
			также вызывает галлюцинации, чем слабее разум цели, тем сильнее галюцинации. \
			Если значение их рассудка достаточно низкое, они обезумеют, лишившись половины имевшегося рассудка."
