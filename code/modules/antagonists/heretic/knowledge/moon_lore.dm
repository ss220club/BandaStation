	...
	for(var/mob/living/carbon/carbon_view in range(7, source))
		...
		if(should_mind_explode(carbon_view))
			to_chat(carbon_view, span_boldbig(span_red(\
				"Ваши чувства охвачены ужасом, когда в ваш разум вторгается посторонняя сила, пытающаяся переписывать ваше существо. \
				Вы даже не успеваете крикнуть, как ваш имплант активирует свою систему аварийной защиты, снося вашу голову.")))
