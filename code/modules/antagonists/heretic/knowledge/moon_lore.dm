/datum/heretic_knowledge_tree_column/moon
	...
	tips = list(
		...
		"Ваше возвышение даст вам ауру, превращающую ближайших к вам людей в верных вам безумцев. Однако, если у цели есть имплант защиты разума, то вместо порабощения, через некоторое время их головы просто взорвутся.",
...
/datum/heretic_knowledge/spell/mind_gate
	...
	desc = "Дарует вам «Врата Разума» - заклинание, отнимающее голос, лишающее слуха, зрения, наводящее галлюцинации, \
		смятение, лишающее воздуха и наносящее урон мозгу цели в течение 10 секунд.\
