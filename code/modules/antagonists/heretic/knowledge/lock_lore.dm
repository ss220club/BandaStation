...
/datum/heretic_knowledge/key_ring
	...
	desc = "Позволяет создать Мистическую карту. \
		...
		Также, она выглядит и работает как обычная ID-карта. \
		Атаки по карте обычными ID-картами поглощает их и получает их доступы. При использовании в руке, она может изменить свой внешний вид на любую поглощенную."
