...
/datum/heretic_knowledge/armor/rust
	...
	desc = "Позволяет трансмутировать стол (или костюм), маску и любой мусор, чтобы создать Уцелевшие обломки. \
			Дает дополнительную броню, сопротивление захвату и невосприимчивать к шприцам, когда находится на ржавчине. \
...
/datum/heretic_knowledge/spell/entropic_plume
	...
	desc = "Дарует вам «Шлейф энтропии», заклинание, выпускающее досаждающую волну ржавчины. \
		Ослепляет, отравляет и накладывает «Амок» на на любого язычника, по которому попадаёт, заставляя его в безумии атаковать \
