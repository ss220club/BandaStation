/datum/heretic_knowledge_tree_column/rust
	...
	tips = list(
		"Ваш Mansus Grasp мгновенно уничтожает мехов, силиконов и андроидов. Попадание вашим клинком по помеченной цели вызывает сильное отвращение и рвоту, на короткое время сбивая её с ног.",
		...
		"Ржавые покрытия исцеляют вас, регулируют температуру крови, делают вас устойчивыми к ударам дубинки, восстанавливают вашу выносливость и кровь, а также исцеляют ваши раны и конечности, как только вы повысите уровень своей пассивной способности.",
