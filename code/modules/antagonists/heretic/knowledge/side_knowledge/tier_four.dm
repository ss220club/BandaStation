...
/datum/heretic_knowledge/spell/space_phase
	...
	gain_text = "Вы ощущаете, что ваше тело может перемещаться по космосу так, словны вы стали космичесой пылью."
...
/datum/heretic_knowledge/rust_sower
	...
	desc = "Позволяет совместить гильзу от химической гранаты и немного заплесневелой еды, чтобы создать проклятую гранату, заполненную Паранормальной Ржавчиной, при взрыве граната выпускает огромное облако, ослепляющее органиков, покрывая поверхности ржавчиной и уничтожая синтетиков и мехов."
