...
/datum/heretic_knowledge/summon/maid_in_mirror
	...
	desc = "Позволяет трансмутировать осколок стекла, любой костюм, и чьи-то лёгкие, чтобы создать Горничную из Зазеркалья. \
			Горничные из Зазеркалья сильные бойцы, способные становиться бестелесными, входя в зеркальное царство и выходя из него, они служат мощными разведчиками и мастерами засад.\
...
/datum/heretic_knowledge/summon/ashy
	...
	gain_text = "Я объединил свой голод с жаждой разрушения. Маршал знал мое имя, а Ночной Дозорный наблюдал за происходящим."
	required_atoms = list(
