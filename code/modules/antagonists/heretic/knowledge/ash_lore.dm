/datum/heretic_knowledge_tree_column/ash
	...
	tips = list(
		...
		"Пепельный Пролёт имеет короткое время перезарядки и способно снимать оковы. При усилении оно даёт более длительный сдвиг, а также снимает оглушение и критический урон по выносливости.",
...
/datum/heretic_knowledge/spell/ash_passage
	...
	desc = "Дарует вам «Пепельный Пролёт» - заклинание, которое позволяет вам исчезнуть из реальности и переместиться на небольшое расстояние, пройдя сквозь любые стены. \
...
/datum/heretic_knowledge/spell/fire_blast
	name = "Взрыв Вулкана"
	desc = "Дарует вам «Volcano Blast» - заклинание, которое после короткой зарядки выстреливает лучом энергии \
...
/datum/heretic_knowledge/spell/flame_birth
	name = "Прерождение Ночного Стража"
	desc = "Дарует вам «Прерождение Ночного Стража» - заклинание, которое тушит вас \
