/datum/heretic_knowledge_tree_column/ash
	...
	pros = list(
		...
		"Довольно мощный эффект от метки.",
	)
	cons = list(
	...
	tips = list(
		...
		"Ashen passage имеет кортокое время перезарядки, способный снять оковы. При усиленном заклинании, вы получаете более длительный сдвиг, а также возможность снимать оглушения и критический урон по выносливости.",
...
/datum/heretic_knowledge/spell/ash_passage
	...
	desc = "Ashen Passage, заклинание, которое позволяет вам исчезнуть из реальности и переместиться на небольшое расстояние, пройдя сквозь любые стены. \
			После активации он избавит вас от оглушения и оков, а также увеличит радиус действия."
