/datum/heretic_knowledge_tree_column/cosmic
	...
	cons = list(
		"Требуется распространять «Метки Звезды», чтобы влиять на противника космическими полями.",
	...
	tips = list(
		"«Хватка Мансуса» помечает вашего противника «Меткой Звезды», а также запоминает место, где он её получил. При активации, помеченный враг перемещается в место, где метка была нанесена и ненадолго лишается способности двигаться.",
		"«Космические руны» позволяют мгновенно переноситься между ними. Однако стоит быть осторожным, так как ими могут воспользоваться и неверные. Будьте креативны, заставьте своих противников перенестись прямо в ловушку. После перемещения, они также получат «Метку Звезды»!",
		"Когда вы стоите на «Космической Руне», вы можете нажать на себя пустой рукой и активировать её.",
		"Противники помеченные «Меткой Звезды» не могут самостоятельно пересечь границу звездного поля. Однако, ничто не помешает их оттуда вытащить!",
...
/datum/heretic_knowledge/spell/cosmic_runes
	...
	desc = "Дарует вам «Космические руны» - заклинание, создающее две руны, связанные друг с другом, позволяющие легко переноситься между ними. \
		Только сущность активировавшая руну будет перенесена, использование руны доступно любому созданию, не обладающему «Меткой Звезды». \
		Однако существа с «Меткой Звезды» будут перенесены вместе с тем, кто использует руну."
...
/datum/heretic_knowledge/spell/star_blast
	...
	desc = "Дарует вам «Звёздный взрыв» - заклинание, пускающее медленно движущийся снаряд, создающий космические поля на своем пути. \
		Любой, пораженный снарядом, получит урон от огня, потеряет сознание и распространит на людей в радиусе трёх клеток от себя «Метку Звезды»."
...
/datum/heretic_knowledge/armor/cosmic
	...
	desc = "Позволяет трансмутировать стол (или костюм), маску и лист плазмы в плащ Сотканный из звёзд, дарующий защиту от космического пространства, а также способность левитировать по желанию. \
