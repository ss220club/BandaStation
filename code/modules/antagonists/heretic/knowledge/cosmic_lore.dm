/datum/heretic_knowledge_tree_column/cosmic
	...
	tips = list(
		"Хватка Мансуса помечает вашего противника Звездной Меткой, а также место, где он её получил. При активации, помеченый враг перемещается в место, где метка была нанесена и ненадолго лишаетс яспособности двигаться.",
		"Космические Руны позволяют мгновенно переноситься между ними. Однако стоит быть осторожным, так как ими могут воспользоваться и не-еретики. Будьте креативны, заставьте своих противников перенестись прямо в ловушку. Они также будут отмечены звездой!",
...
/datum/heretic_knowledge/spell/star_blast
	name = "Звездный взрыв"
	desc = "Выпускает медленно движущийся снаряд, создающий космические поля на своем пути. \
		Любой, пораженный снарядом получит урон от огня, потеряет сознание и установит на людей в радиусе трёх клеток звёздную метку."
...
/datum/heretic_knowledge/armor/cosmic
	...
	desc = "Позволяет трансмутировать стол (или костюм), маску и лист плазмы в Сотканный из звезд Плащ, дающий защиту от космического пространства, а также способность левитировать по желанию. \
