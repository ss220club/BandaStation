...
/datum/heretic_knowledge/blade_upgrade/cosmic
	name = "Cosmic Blade"
	desc = "Теперь ваш клинок наносит Метку звезды жертвам, а также позволяет атаковать отмеченных ею на расстоянии. \
...
/datum/heretic_knowledge/ultimate/cosmic_final
	...
	desc = "Ритуал вознесения Пути Космоса. \
		Для завершения ритуала принесите 3 трупа отмеченных Меткой звезды к руне трансмутации. \
