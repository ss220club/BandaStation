/datum/heretic_knowledge_tree_column/cosmic
	...
	description = list(
		...
		"Выбирайте этот путь, если вам нравится приспосабливаться к окружающей среде, и мыслить вне рамок (ну или внутри них).",
	)
	pros = list(
	...
	cons = list(
		...
		"Относительно низкая выживаемость, с сильной зависимостью на правильное использование способностей.",
	)
	tips = list(
		"Ваша Хватка Мансуса помечает вашего противница звездой, а также оставляет метку, при срабатывании которой помеченый враг телепортируется в место, где метка была нанесена, ненадолго парализуя его.",
		"Ваши космические руны могут мгновенно телепортировать вас из между друг другом. Однако стоит быть осторожным, так как ими могут воспользоваться и не-еретики. Будьте креативны, заставьте своих противников телепортироваться прямо в ловушку. Они так же будут отмечены звездой!",
		"Когда вы стоите на космической руне, вы можете нажать на себя пустой рукой и активировать её.",
		"Противники помеченные вашей звездой не могут самостоятельно пересечь границу звездного поля. Однако, ничто не помешает их оттуда вытащить!",
		"Звёздный взрыв одновременно является способностью повышающей вашу подвижность,и также средством выведения из строя. Используйте её, чтобы поймать в своё звездное поле сразу несколько человек.",
...
/datum/heretic_knowledge/spell/cosmic_runes
	name = "Cosmic Runes"
	desc = "Дарует вам Космичесские Руны, заклинание, которое создает две руны, связанные друг с другом для легкой телепортации. \
...
/datum/heretic_knowledge/spell/star_blast
	name = "Звездный взрыв"
	desc = "Выпускает медленно движущийся снаряд, создающий космичесские поля на своем пути. \
		Любой, пораженный снаряом получит урон от огня, потеряет сознание и установит на людей в радиусе трёх клеток звёздную метку."
	gain_text = "С каждой новой жерствой, как никогда ранее четко слышу я слова Зверя, стоящего за мной."
	action_to_add = /datum/action/cooldown/spell/pointed/projectile/star_blast
	cost = 2

/datum/heretic_knowledge/armor/cosmic

	desc = "Позволяет трансмутировать стол (или костюм), маску и лист плазмы в Сотканный из звезд Плащ, дающий защиту от космического пространсва, а также способность левитировать по желанию. \
			Действует как фокусировка пока надет плащ."
	gain_text = "Подобно сияющим нитям, сияли звезды, соединяясь в шелковистую форму развевающегося плаща, который окутывает и обнажает мои плечи. \
				Глаза Зверя смотрят на и сквозь меня."
...
/datum/heretic_knowledge/spell/star_touch
	name = "Касание Звезды"
	desc = "Дарует вам Касание Звезды, заклинание, которое помещает Метку звезды на вашу цель \
...
/datum/heretic_knowledge/spell/cosmic_expansion
	...
	desc = "Дарует вам Космичесская Экспансия, заклинание, создающее вокруг вас область космических полей размером 5x5. \
...
/datum/heretic_knowledge/ultimate/cosmic_final
	...
	desc = "Ритуал вознесения Пути Космоса. \
		...
		Заклинание Космичесская Экспансия и ваши клинки также значительно усилены."
