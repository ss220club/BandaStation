...
/atom/movable/screen/alert/status_effect/eldritch_painting/desire
	name = "Первое желание"
	desc = "Вы чувствуете зверский голод! УТОЛИТЕ ЕГО ЛЮБОЙ ЦЕНОЙ! Или, может быть, просто пойдите полюбуйтесь картиной и насладитесь великолепным блюдом, которое она обещает..."
...
/atom/movable/screen/alert/status_effect/eldritch_painting/beauty
	name = "Владычица врат"
	desc = "Ваша одежда скрывает красоту, которая скрывается под ней. Снимите её и достигните совершенства. Или на краткий миг узрите совершенство на картине, в которой вы увидели свой идеальный образ."
