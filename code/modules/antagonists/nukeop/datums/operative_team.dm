...
/datum/team/nuclear/roundend_report()
	...
	switch(get_result())
		...
		if(NUKE_RESULT_HIJACK_DISK)
			...
			parts += "<B>Оперативники [syndicate_name] провалились в уничтожении [station_name()], но им удалось захватить диск и угнать эвакуационный шаттл, в результате чего он приземлился на базе синдиката. Хорошая работа?</B>"
		if(NUKE_RESULT_HIJACK_NO_DISK)
			parts += "<span class='greentext big'>Незначительная победа Синдиката!</span>"
			parts += "<B>Оперативники [syndicate_name] провалились в уничтожении [station_name()] и в сохранении диска, но им удалось угнать эвакуационный шаттл, в результате чего он приземлился на базе синдиката. Хорошая работа?</B>"
