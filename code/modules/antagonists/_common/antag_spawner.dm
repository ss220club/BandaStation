...
/obj/item/antag_spawner/contract/spawn_antag(client/C, turf/T, kind, datum/mind/user)
	...
	C.prefs.safe_transfer_prefs_to(M, is_antag = TRUE, do_not_apply = list(/datum/preference/body_modifications)) // BANDASTATION MOD - Do not apply body mods on roles
...
/obj/item/antag_spawner/nuke_ops/spawn_antag(client/our_client, turf/T, kind, datum/mind/user)
	...
	our_client.prefs.safe_transfer_prefs_to(nukie, is_antag = TRUE, do_not_apply = list(/datum/preference/body_modifications)) // BANDASTATION MOD - Do not apply body mods on roles
...
/obj/item/antag_spawner/loadout/spawn_antag(client/our_client, turf/T, mob/user)
	...
	var/obj/structure/closet/supplypod/pod = setup_pod()
	our_client.prefs.safe_transfer_prefs_to(spawned_mob, is_antag = TRUE, do_not_apply = list(/datum/preference/body_modifications)) // BANDASTATION MOD - Do not apply body mods on roles
