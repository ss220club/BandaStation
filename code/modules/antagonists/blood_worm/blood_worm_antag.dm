...
/datum/antagonist/blood_worm/greet()
	...
	to_chat(owner, span_bold("Разновидность космических пиявок огромных размеров, известных своей свирепостью при охоте.\
							...
							Неудачный проект биологичесского оружия Синдиката, закрытый покровителями из-за 'отсутсвия результатов', и всё же...\
							Вы обнаруживаете себя на космичесской станции Нанотрейзен. Прекрасная среда обитания, не правда ли?"))
	to_chat(owner, span_bolddanger("УБЕЙ, ПОГЛОТИ, РАЗМНОЖСЯ, ЗАХВАТИ."))
