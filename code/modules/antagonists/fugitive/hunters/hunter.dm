...
/datum/antagonist/fugitive_hunter/greet()
	switch(backstory)
		...
		if(HUNTER_PACK_BOUNTY)
			...
			to_chat(owner, span_danger("Разведданые сообщали, что наша цель находится на исследовательской станции. Необычное место для преступника, чтобы залечь на дно."))
