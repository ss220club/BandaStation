...
/datum/emote/living/carbon/human/aprilfools/hiii
	key = "hiii"
	message = "машет ручкой."
	emote_icon_state = "hiii"
	sound = 'sound/effects/aprilfools/hiii.ogg'

/datum/emote/living/carbon/human/aprilfools/muhehe
	key = "muhehe"
	message = "злорадно смеётся."
	emote_icon_state = "muhehe"
	sound = 'sound/effects/aprilfools/muhehe.ogg'

/datum/emote/living/carbon/human/aprilfools/wrong
	key = "wrong"
	message = "не соглашается!"
	emote_icon_state = "wrong"
	sound = 'sound/effects/aprilfools/wrong.ogg'

/datum/emote/living/carbon/human/aprilfools/correct
	key = "correct"
	message = "соглашается!"
	emote_icon_state = "correct"
	sound = 'sound/effects/aprilfools/correct.ogg'
