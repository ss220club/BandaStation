...
/datum/species/proc/harm(mob/living/carbon/human/user, mob/living/carbon/human/target, datum/martial_art/attacker_style)
	...
	if(user_drunkenness)
		if(HAS_TRAIT(user, TRAIT_DRUNKEN_BRAWLER)) // Drunken brawlers only need to be intoxicated, doesn't matter how much
			...
			atk_verb = "[drunken_martial_descriptor] [ru_attack_verb(capitalize(atk_verb)]"
			atk_verb_continuous = "[drunken_martial_descriptor] [capitalize(atk_verb, GLOB.ru_attack_verbs_unarmed)_continuous)]"
