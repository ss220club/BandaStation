...
/datum/species/moth/get_species_description()
	...
	Они общительны, ценят коллектив и известны как торговцы, инженеры и посредники в галактике."
...
/datum/species/moth/get_species_lore()
	...
	"Кочевая жизнь сформировала сплочённую культуру, в которой нианы высоко ценят друзей, семью и свои корабли. \
	По своей природе они общительны и лучше всего чувствуют себя в коллективе. Это сослужило им хорошую службу на галактической арене, \
	...
	"Удивительно, но совместная жизнь в рамках одного огромного флота не сгладила различия в диалектах и культуре. \
