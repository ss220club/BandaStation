	...
	if(hasPower() && unres_sides)
		for(var/heading in list(NORTH,SOUTH,EAST,WEST))
			if(!(unres_sides & heading))
				continue
			var/mutable_appearance/floorlight = mutable_appearance('modular_bandastation/aesthetics/airlocks/icons/station/overlays.dmi', "unres_[heading]", FLOAT_LAYER, src, O_LIGHTING_VISUAL_PLANE, appearance_flags = RESET_COLOR | KEEP_APART) // BANDASTATION EDIT - AESTHETICS - ORIGINAL: icons/obj/doors/airlocks/station/overlays.dmi
