...
/obj/item/picket_sign/cyborg
	...
	desc = "Высокотехнологичный плакат используемый кремниевыми формами жизни с возможностью в любой момент изменить надпись. Да, думаю получить таким по голове тоже будет больновато."
	force = 13
