...
/obj/item/ai_module/supplied/safeguard
	name = "Модуль закона ИИ 'Телохранитель'"
	var/targetName = ""
...
/obj/item/ai_module/supplied/protect_station
	name = "Модуль закона ИИ 'Защита станции'"
...
/obj/item/ai_module/supplied/quarantine
	name = "Модуль закона ИИ 'Карантин'"
...
/obj/item/ai_module/supplied/oxygen
	name = "Модуль закона ИИ 'Кислород токсичен для людей'"
