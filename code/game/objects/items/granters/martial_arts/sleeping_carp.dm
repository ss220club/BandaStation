/obj/item/book/granter/martial/carp
	...
	desc = "Свиток, испещренный странными знаками. Похоже, это зарисовки какого-то боевого искусства."
	greet = span_sciradio("Вы овладели древним боевым искусством Спящего Карпа! Ваш рукопашный бой стал намного эффективнее, и теперь, находясь в боевом режиме, вы способны отражать любые снаряды.\
		...
		Ваше тело также укрепилось, обеспечивая дополнительную защиту от серьезных ран которые иначе накапливались бы во время затяжного боя. Однако вы также теряете способность \
	...
	remarks = list(
		"Подождите, диета с высоким содержанием белка - это действительно все, что нужно, чтобы стать устойчивым к колото-ножевым ранениям...?",
