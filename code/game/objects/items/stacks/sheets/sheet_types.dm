...
GLOBAL_LIST_INIT(metal_recipes, list ( \
	...
	new/datum/stack_recipe("electrochromic controller frame", /obj/item/wallframe/button/electrochromic, 1, crafting_flags = NONE, category = CAT_STRUCTURE), /* BANDASTATION ADDITION */ \
