...
GLOBAL_LIST_INIT(glass_recipes, list ( \
	...
	new/datum/stack_recipe("fulltile electrochromic window", /obj/structure/window/fulltile/unanchored/electrochromic, 4, time = 2 SECONDS, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_ON_SOLID_GROUND | CRAFT_IS_FULLTILE, category = CAT_WINDOWS), /* BANDASTATION ADDITION */ \
...
GLOBAL_LIST_INIT(reinforced_glass_recipes, list ( \
	...
	new/datum/stack_recipe("fulltile reinforced electrochromic window", /obj/structure/window/reinforced/fulltile/unanchored/electrochromic, 4, time = 4 SECONDS, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_ON_SOLID_GROUND | CRAFT_IS_FULLTILE, category = CAT_WINDOWS), /* BANDASTATION ADDITION */ \
