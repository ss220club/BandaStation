...
GLOBAL_LIST_INIT(leather_recipes, list ( \
	...
	new/datum/stack_recipe_list("belts", list( \
		...
		new/datum/stack_recipe("shoulder holster", /obj/item/clothing/accessory/holster, 3, crafting_flags = NONE, category = CAT_CONTAINERS), \ /// BANDA STATION MOD: Accessory holsters
