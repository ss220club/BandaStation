...
/datum/objective_item/steal/traitor/nullrod
	...
	exists_on_map = TRUE
	difficulty = 2
	steal_hint = "Священный артефакт, ообычно находящийся у священника. Если нет у священника, то можно найти в комнате священника. \
...
/datum/objective_item/steal/traitor/mime_mask
	...
	exists_on_map = TRUE
	difficulty = 1
	steal_hint = "Маска мима. Он всегда должен быть на лице мима."
...
/datum/objective_item/steal/traitor/chef_moustache
	...
	exists_on_map = TRUE
	difficulty = 1
	steal_hint = "Искусственные итальянские усы шеф-повара, найденные либо на лице, либо в мусорном ведре, в зависимости от того, кто дежурит."
...
/datum/objective_item/steal/traitor/telebaton
	...
	exists_on_map = TRUE
	difficulty = 3
	steal_hint = "Оружие самообороны, стандартное для всех глав отделов, за исключением начальника службы безопасности."
...
/datum/objective_item/steal/traitor/captain_spare
	...
	steal_hint = "Запасная ID-карта самого главного на этой станции. \
		Если поблизости нет официального капитана, вы можете найти его приколотым к груди исполняющего обязанности капитана - одного из глав отдела. \
...
/datum/objective_item/steal/caplaser
	...
	exists_on_map = TRUE
	difficulty = 4
	steal_hint = "Самозарядный лазерный пистолет, что может быть найден в витрине в каюте капитана. \
...
/datum/objective_item/steal/hoslaser
	name = "персональный лазерный пистолет главы службы безопасности"
	targetitem = /obj/item/gun/energy/e_gun/hos
	excludefromjob = list(JOB_HEAD_OF_SECURITY)
	item_owner = list(JOB_HEAD_OF_SECURITY)
	exists_on_map = TRUE
	difficulty = 4
	steal_hint = "Уникальный трехрежимный лазерный пистолет главы службы безопасности. \
...
/datum/objective_item/steal/compactshotty
	name = "перональный компактный дробовик смотрителя"
...
/datum/objective_item/steal/magboots
	name = "продвинутые магнитые ботинки главного инженера"
...
/datum/objective_item/steal/hypo
	...
	steal_hint = "Персональный медицинский инжектор главного врача. \
		Обычно находящийся у него в медицинских принадлежностях или на поясе. Так же может быть найден в шкафу в его кабинете."
...
/datum/objective_item/steal/nukedisc
	...
	excludefromjob = list(JOB_CAPTAIN)
	difficulty = 5
	steal_hint = "Вы знаете что за диск. Постоянно находится при капитане (возможно). \
...
/datum/objective_item/steal/ablative
	...
	exists_on_map = TRUE
	difficulty = 4
	steal_hint = "Абляционный плащ, что может быть найден в оружейной."
...
/datum/objective_item/steal/reactive
	...
	steal_hint = "Специальная броня, что может быть у директора исследований. \
		Так же может быть найден в шкафчике."
...
/datum/objective_item/steal/hdd_extraction
	...
	exists_on_map = TRUE
	difficulty = 4
	steal_hint = "Жесткий диск главного исследовательского сервера. Находится в серверной исследований и разработок."
...
/datum/objective_item/steal/blackbox
	...
	exists_on_map = TRUE
	difficulty = 4
	steal_hint = "Черный ящик данных станции, доступный исключительно в телекоммуникационных сетях."
	destruction_method = "Слишком крепкий, чтобы его можно было уничтожить обычными средствами - его нужно стереть в порошок с помощью суперматерии или сжечь в крематории часовни."
...
/datum/objective_item/steal/traitor/moth_plush
	...
	exists_on_map = TRUE
	difficulty = 1
	steal_hint = "Плюшевая моль. Так же может быть найден у психолога, что лечит душевные травмы этой молью."
...
/datum/objective_item/steal/traitor/lizard_plush
	name = "плюшевая милая ящерица"
	targetitem = /obj/item/toy/plush/lizard_plushie
	exists_on_map = TRUE
	difficulty = 1
	steal_hint = "Плюшевая ящерица. Так же может быть найден в технических тоннелях."
...
/datum/objective_item/steal/traitor/denied_stamp
	name = "штамп отклонения снабжения"
...
/datum/objective_item/steal/traitor/granted_stamp
	name = "штамп подтверждения снабжения"
...
/datum/objective_item/steal/spy/lamarr
	...
	exists_on_map = TRUE
	difficulty = 3
	steal_hint = "Хедкраб директора исследований Ламарр. Может быть найден в кабинете директора исследований."
...
/datum/objective_item/steal/spy/energy_gun
	...
	exists_on_map = TRUE
	difficulty = 2
	steal_hint = "Двухрежимный энергетический карабин, что может быть найден в оружейной. Так же может быть у некоторых глав для их персональной защиты."
...
/datum/objective_item/steal/spy/laser_gun
	...
	exists_on_map = TRUE
	difficulty = 3
	steal_hint = "Простой лазерный карабин, что может быть найден в оружейной."
...
/datum/objective_item/steal/spy/shotgun
	...
	exists_on_map = TRUE
	difficulty = 3
	steal_hint = "Служебный дробовик для подавления бунтов, что может быть найден в оружейной."
...
/datum/objective_item/steal/spy/temp_gun
	...
	steal_hint = "Надёжная температурная винтовка СБ, что может быть найдена в оружейной."
...
/datum/objective_item/steal/spy/stamp
	...
	exists_on_map = TRUE
	difficulty = 1
	steal_hint = "Штамп, принадлежащий главе отдела, что может быть найдена в их офисе."
...
/datum/objective_item/steal/spy/sunglasses
	...
	difficulty = 1
	steal_hint = "Пара солнцезащитных очков. У юристов обычно есть несколько штук, как и у некоторых глав. Также их можно получить, разобрав HUD-очки"
...
/datum/objective_item/steal/spy/rd_modsuit
	...
	exists_on_map = TRUE
	difficulty = 2
	steal_hint = "Громоздкий МОД-костюм директора исследований в опасных условиях на рабочем месте. Можно найти у директора исследований или в его кабинете."
