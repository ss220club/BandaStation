...
GLOBAL_LIST_INIT(local_to_logis_logs_map, list(
    ...
    LOG_CATEGORY_DEBUG_MAPPING = LOGIS_LOG_CATEGORY_VISUALS,
    ...
    LOG_CATEGORY_UPLINK_CHANGELING = LOGIS_LOG_CATEGORY_CONVERSION,
    LOG_CATEGORY_UPLINK_HERETIC = LOGIS_LOG_CATEGORY_CONVERSION,
    LOG_CATEGORY_UPLINK_MALF = LOGIS_LOG_CATEGORY_CONVERSION,
    LOG_CATEGORY_UPLINK_SPELL = LOGIS_LOG_CATEGORY_CONVERSION,
