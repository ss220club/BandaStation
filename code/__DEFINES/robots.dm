...
#define BEEPSKY_VOICED_FENTONYL_IN_POCKET "База 44, у него в кармане фентонил"
#define BEEPSKY_VOICED_HOW_TO_SHOOT "Что мне нажать, чтобы выстрелить?"
#define BEEPSKY_VOICED_NEED_BACKUP "Давай, поторопись! Отправь подкрепление! Помогите этим сукам! Здесь этим сукам нужно подкрепление, чувак. У меня здесь нагрудная камера в прямом эфире с шоу Гуччи Мейна! Мы на этом чертовом месте. Ты знаешь о чем идет речь. У! У!"
...
#define MEDIBOT_VOICED_BE_CAREFUL "Будь осторожен. Он же дом проверяет, братан"
#define MEDIBOT_VOICED_BIG_FOOL "Ты большой дурак! Абсолютно!"
#define MEDIBOT_VOICED_COME_HERE_COME_HERE "Иди сюда! Иди сюда! Иди сюда! Иди сюда! Иди сюда! Иди сюда!"
#define MEDIBOT_VOICED_COME_ON "Не начинай, ну давай"
#define MEDIBOT_VOICED_DONT_MOVE "Лежи, мать твою!"
#define MEDIBOT_VOICED_DRIVE_NORMALLY "Давай, езжай нормально!"
#define MEDIBOT_VOICED_FRIENDS_NOW "Хорошо, мы теперь друзья!"
#define MEDIBOT_VOICED_FUNNY "Блин, это просто охуенно смешно"
#define MEDIBOT_VOICED_GOD_BLESS_AMERICA_CHAT "О боже, благослови Америку! Благослови Америку, чат! Что это за водная горка?! Бро, чат, о боже мой!"
#define MEDIBOT_VOICED_HE_DID_IT_ON_PURPOSE "Ну чат, он сделал это нарочно. Я думал, это что-то вроде детского аттракциона"
#define MEDIBOT_VOICED_IDIOT_WHERE_YOU_CAME_FROM "Идиот, серьезно, откуда ты взялся? Боже, черт возьми, ты идиот!"
#define MEDIBOT_VOICED_IT_WAS_A_WALLET "Я подумал, что это был чертов кошелек! Я потянулся за ним... И оно сквозь мои чертовы пальцы размазалось! ЭТО БЫЛО ДЕРЬМО"
#define MEDIBOT_VOICED_JUNKIE_POWER "Да, сила наркоманов настоящая"
#define MEDIBOT_VOICED_JUNKIE_WORLD "Что происходит в прекрасном мире наркоманов этим утром?"
#define MEDIBOT_VOICED_MY_MIND_SAYS_NO "Мой разум говорит нет. Но крэк... крэк говорит мне да!"
#define MEDIBOT_VOICED_NEEDA_STOP_BEING_ANGRY "Надо перестать злиться сейчас же"
#define MEDIBOT_VOICED_NEXT_BUS "Извините! Когда прибудет следующий автобус?"
#define MEDIBOT_VOICED_NO_INSURANCE "У него нет страховки. И он так накачан наркотиками, что не может превысить скорость. Так что он совершенно безопасен"
#define MEDIBOT_VOICED_NO_SKATEBOARDING "Никакого скейтбординга, никакой езды не велосипеде, никаких роликов, никакой езды на самокате!"
#define MEDIBOT_VOICED_POOP_IN_MY_HAND "Дерьмо в моей руке! Я думал, это был кошелек"
#define MEDIBOT_VOICED_SHIT_CHAT "О черт нет! О черт нет, чат! Чувак, убери меня с этой фигни!"
#define MEDIBOT_VOICED_STOP_MESSING_WITH_OVEN "Хватит возиться с микроволновкой"
#define MEDIBOT_VOICED_STUBBORN_SHEEP "Как упрямый баран, просто стоишь там! Ты пухлый дурак!"
#define MEDIBOT_VOICED_TEST_CHAMBER "Спускай свою тупую задницу в испытательную камеру иначе я засуну образец тебе в зад!"
#define MEDIBOT_VOICED_THANKS "Спасибо, мистер Эпштейн. Буду осторожнее"
#define MEDIBOT_VOICED_THATS_WHY "Ты сукин сын! Вот почему ты сказал мне сесть на это дерьмо"
#define MEDIBOT_VOICED_THOUGHT_YOU_HIGH "О, я думал, ты под кайфом, не знаю.. Эй, братан, расслабься!"
#define MEDIBOT_VOICED_UNACCEPTABLE_TEXT "Этот текст неприемлем из-за его рассистского содержания!"
#define MEDIBOT_VOICED_WAIT_OH_SHIT "Эй, это... О черт нет! О черт нет!"
#define MEDIBOT_VOICED_WAIT_WTF "Подожди, что за черт!"
#define MEDIBOT_VOICED_WANT_TO_BE_FRIENDS "Я просто хочу быть друзьями. Это все, чего я хочу. Я хочу быть друзьями"
#define MEDIBOT_VOICED_WATER_OH_SHIT "Это вода?! О черт!"
#define MEDIBOT_VOICED_WDYM_YOU_GO "Чувак, ты в каком смысле собрался отсюда уходить, а?"
#define MEDIBOT_VOICED_WTF "Что это блять!"
#define MEDIBOT_VOICED_YO "Йо!"
#define MEDIBOT_VOICED_YOU_DONT_NEED_HELP "Тебе не нужна помощь. Ты не хочешь, чтобы кто-то помог с другой стороны"
#define MEDIBOT_VOICED_YOU_HAVE_TO_UNDERSTAND "Ты должен понять кое-что. Если ты будешь с нами шутить или сделаешь что-то плохое... Мы тебя изнасилуем и убъем"
#define MEDIBOT_VOICED_YOURE_DONE "Хорошо, ты готов!"
