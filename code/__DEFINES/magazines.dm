...
#define MAGAZINE_DESC_HOLLOWPOINT "<br>Содержит экспансивные патроны, которые эффективны против небронированных целей, но малоэффективны против бронированных целей."
...
#define MAGAZINE_DESC_ARMORPIERCE "<br>Содержит бронебойные патроны, которые эффективны против бронированных целей, но малоэффективны против небронированных целей."
