...
// BANDASTATION MOD START: displacement shadows (see shadows.dm)
#ifdef DYN_SHADOWS_ENABLED

#define WALL_RENDER_TARGET "*wall_plane"

#define PLANE_SHADOWS_WALLS -22

// shadow cascade (main) filter stack - no map atoms should use this plane
#define SHADOWS_CASCADE_VISIBLE_PLANE -9
// second shadow cascade pass (shadow body) - filter-only, unique plane so plane_masters list does not collapse with main
#define SHADOWS_CASCADE_ADDITIVE_PLANE -13
#define FLOOR_PLANE -8
#define WALL_PLANE -7
#define GAME_PLANE -5
#define ABOVE_GAME_PLANE -3
#define SHADOWS_CASCADE_RENDER_TARGET "*shadows cascade: AUTOGENERATED RENDER TGT"
#define SHADOWS_CASCADE_ADDITIVE_RENDER_TARGET "*shadows cascade additive: AUTOGENERATED RENDER TGT"

#define SHADOW_SOURCE_PLANE -48
#define SHADOW_SOURCE_RENDER_TARGET "*SHADOW_SOURCE_PLANE"
#else
