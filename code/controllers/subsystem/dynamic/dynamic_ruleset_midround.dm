...
/datum/dynamic_ruleset/midround/from_ghosts/prepare_for_role(datum/mind/candidate)
	...
	if(ishuman(body))
		...
		body.client?.prefs.safe_transfer_prefs_to(body, is_antag = TRUE, do_not_apply = list(/datum/preference/body_modifications)) // BANDASTATION MOD - Do not apply body mods on roles
