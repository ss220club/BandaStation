...
/datum/brain_trauma/mild/speech_impediment
	...
	gain_text = span_danger("Кажется, вы не можешь сформулировать ни одной связной мысли!")
...
/datum/brain_trauma/mild/mind_echo
	name = "Мысленное эхо"
	desc = "Языковые нейроны пациента не завершаются должным образом, в результате чего предыдущие речевые структуры иногда спонтанно всплывают на поверхность."
