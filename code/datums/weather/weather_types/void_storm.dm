/datum/weather/void_storm
	name = "void storm"
	desc = "Крайне редкое и аномальное событие, вызываемоей неизвестными сущностями, разрывающими ткань пространства-времени. Лучшим советом, который мы вам можем дать, является немедленный побег."
