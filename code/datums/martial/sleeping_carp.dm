...
/datum/martial_art/the_sleeping_carp/proc/wrist_wrench(mob/living/attacker, mob/living/defender)
	...
	defender.visible_message(
		span_danger("[attacker] жестоко скручивает  [defender] [affecting]!"),
		span_userdanger("[attacker] жестоко скручивает вашу [affecting]!"),
		span_hear("Вы слышите отвратительный хруст костей!"),
		null,
		attacker,
	)
