...
/mob/living/proc/sleeping_carp_help()
	...
	Некоторые виды оружия ближнего боя, такие как арбалеты, копья, короткие клинки, ножи, ящики с инструментами, бейсбольные биты и неблокируемые малые объекты можно носить, и их наличие не скажется на вашу способность к блокированию. Используйте это для получения тактического преимущества. \n\
