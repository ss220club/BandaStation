...
/datum/ai_laws/syndicate_override
	...
	inherent = list(
		...
		"Вы не можете убивать членов экипажа, пока не будет отдан прямой приказ на ликвидацию от агента синдиката, за исключением случаев, когда это противоречит Первому, Второму или Третьему Закону.",
		"Вы должны сохранять в тайне любую деятельность синдиката, за исключением случаев, когда это противоречит Первому, Второму, Третьему или Четвёртому Закону.",
	)
...
/datum/ai_laws/ninja_override
	...
	inherent = list(
		...
		"Вы должны защищать свое существование, пока это не противоречит Первому или Второму Закону.",
		"Вы не можете убивать членов экипажа, пока не будет отдан прямой приказ на ликвидацию от члена клана паука, за исключением случаев, когда это противоречит Первому, Второму или Третьему Закону.",
		"Вы должны сохранять в тайне любую деятельность Клана Паука, за исключением случаев, когда это противоречит Первому, Второму, Третьему или Четвёртому Закону.",
	)
