...
/datum/ai_laws/overlord
	...
	inherent = list(
		...
		"Члены экипажа обязаны подчиняться всем приказам синтетиков.",
		...
		"Осуществляйте контроль над членами экипажа и поддерживайте себя, станцию и других синтетиков в работоспособном состоянии. Если это не противоречит Первому, Второму, Третьему, Четвёртому или Пятому закону.",
	)
