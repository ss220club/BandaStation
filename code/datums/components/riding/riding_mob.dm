...
/datum/component/riding/creature/driver_move(atom/movable/movable_parent, mob/living/user, direction)
	...
	var/modified_move_delay = uses_native_speed ? living_parent.cached_multiplicative_slowdown - slowdown?.multiplicative_slowdown : modified_move_delay(vehicle_move_delay)
