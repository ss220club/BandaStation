...
/datum/component/uplink/ui_data(mob/user)
	...
	// BANDASTATION ADDITION EDIT START: data["joined_population"] = length(GLOB.joined_player_list)
	...
	// BANDASTATION ADDITION EDIT END
	data["current_progression_scaling"] = SStraitor.current_progression_scaling

	data["maximum_potential_objectives"] = uplink_handler.maximum_potential_objectives // BANDASTATION ADDITION
...
/datum/component/uplink/ui_static_data(mob/user)
	...
	data["has_objectives"] = uplink_handler.has_objectives // BANDASTATION ADDITION
