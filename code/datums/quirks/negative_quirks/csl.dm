/datum/quirk/csl
	name = "Общий - второй язык"
	desc = "Общий язык не является вашим родным языком — это нечто, чему вам пришлось научиться в процессе жизни. \
	...
	value = -2
	gain_text = span_danger("Вам трудно понимать Общий язык.")
	lose_text = span_notice("Вы начинаете лучше разбираться в Общем языке.")
