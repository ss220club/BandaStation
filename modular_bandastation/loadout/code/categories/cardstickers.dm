...
/datum/loadout_item/id_sticker/on_equip_item(obj/item/equipped_item, datum/preferences/preference_source, list/preference_list, mob/living/carbon/human/equipper, datum/outfit/outfit, list/item_details, visuals_only = FALSE )
	if(visuals_only)
		return NONE
	. = ..()
