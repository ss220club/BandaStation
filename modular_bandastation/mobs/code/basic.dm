...
/mob/living/basic/crocodile
	...
	/// What Croco eats
	var/static/list/croco_diet = list(/obj/item/food/meat)
...
/mob/living/basic/crocodile/Initialize(mapload)
	...
	AddElement(/datum/element/basic_eating, heal_amt = 10, food_types = croco_diet)
	AddComponent(/datum/component/health_scaling_effects, min_health_slowdown = 1.5)
	ai_controller.set_blackboard_key(BB_BASIC_FOODS, typecacheof(croco_diet))
