/mob/living/basic/pet/dog/security
	name = "Мухтар"
	real_name = "Мухтар"
...
/mob/living/basic/pet/dog/security/warden
	name = "Джульбарс"
	real_name = "Джульбарс"
...
/mob/living/basic/pet/dog/security/detective
	name = "Гав-Гавыч"
...
/mob/living/basic/pet/dog/security/on_lying_down(new_lying_angle)
	..()
...
/mob/living/basic/pet/dog/security/on_standing_up(updating = 1)
	..()
	if(icon_resting && stat != DEAD)
...
/mob/living/basic/pet/dog/security/Initialize(mapload)
	. = ..()
	regenerate_icons()

/mob/living/basic/pet/dog/security/Destroy()
	QDEL_NULL(inventory_head)
	QDEL_NULL(inventory_mask)
	return ..()

/mob/living/basic/pet/dog/security/handle_atom_del(atom/A)
	if(A == inventory_head)
		inventory_head = null
		regenerate_icons()
	if(A == inventory_mask)
...
/mob/living/basic/pet/dog/security/Life(seconds, times_fired)
	. = ..()
	regenerate_icons()

/mob/living/basic/pet/dog/security/death(gibbed)
	..(gibbed)
	regenerate_icons()

/mob/living/basic/pet/dog/security/proc/place_on_head(obj/item/item_to_add, mob/user)
...
/mob/living/basic/pet/dog/security/proc/update_muhtar_fluff()
...
/mob/living/basic/pet/dog/security/regenerate_icons()
	..()
	if(inventory_head)
		var/image/head_icon
		var/datum/muhtar_fashion/DF = new inventory_head.muhtar_fashion(src)
