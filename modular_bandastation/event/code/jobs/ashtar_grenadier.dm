/datum/job/vulp_ashtar_grenadier
	title = "Гранатометчик Аштара"
	supervisors = "офицером вашего отделения"
	description = "Будьте готовы пойти на штурм с большой бум-палкой, станьте тем кого стоит боятся, а также будьте готовы умереть за свой клан! Вас точно не забудут."
	departments_list = list(
		/datum/job_department/security,
	)
	outfit = /datum/outfit/vulpa_ashtar/rpg
