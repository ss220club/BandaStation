/datum/job/vulp_ashtar_engi
	...
	description = "Будьте готовы создать лучшие укрепления для своих соклановцев, станьте последним в числе погибших, а также будьте готовы умереть за свой клан! Вас точно не забудут."
