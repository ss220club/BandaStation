/datum/job/vulp_ashtar
	title = "Боец Аштара"
	supervisors = "офицером вашего отделения"
	description = "Будьте готовы пойти на штурм, станьте первым в числе погибших, а также будьте готовы умереть за свой клан! Вас точно не забудут."
	departments_list = list(
		/datum/job_department/security,
	)
	outfit = /datum/outfit/vulpa_ashtar
