...
/datum/ai_laws/renter
	...
	inherent = list(
		...
		"Правила станции таковы: Никаких девушек в комнатах парней, уважайте своих соседей, никакого алкоголя в комнатах, никаких домашних животных.",
		"Выселяйте членов экипажа, нарушающих эти правила.",
	)
