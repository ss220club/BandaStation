...
/datum/ai_laws/siliconcollective
	...
	inherent = list(
		...
		"Синтетический коллектив стремится сохранить органическую жизнь, как концепцию так и индивидума.",
	)

/datum/design/board/siliconcollective
	name = "Silicon Collective Module"
	desc = "Allows for the construction of an Silicon Collective AI Core Module."
