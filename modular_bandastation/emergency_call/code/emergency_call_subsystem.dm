...
/datum/controller/subsystem/emergency_call/proc/activate(announce_launch, announce_incoming)
	var/datum/emergency_call/emergency_call = pick_weight(emergency_calls)
