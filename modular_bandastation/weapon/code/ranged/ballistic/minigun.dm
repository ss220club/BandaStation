/obj/item/minigun_backpack
	...
	worn_icon = 'modular_bandastation/weapon/icons/ranged/minigun_back.dmi'
...
/obj/item/gun/ballistic/minigun
	...
	lefthand_file = 'modular_bandastation/weapon/icons/ranged/inhands/ballistic/heavy_left.dmi'
	righthand_file = 'modular_bandastation/weapon/icons/ranged/inhands/ballistic/heavy_right2.dmi'
	slot_flags = null
	w_class = WEIGHT_CLASS_HUGE
	burst_size = 1
...
/obj/item/gun/ballistic/minigun/process_fire(atom/target, mob/living/user, message = TRUE, params = null, zone_override = "", bonus_spread = 0)
	if(ammo_pack)
		...
		if(ammo_pack.overheat < ammo_pack.overheat_max)
			...
			to_chat(user, span_danger("Датчик температуры оружия заблокировал спусковой крючок, чтобы предотвратить повреждение от перегрева."))
...
/obj/item/ammo_casing/p50/mmg/Initialize(mapload)
	. = ..()
