...
/obj/item/gun/ballistic/automatic/carwo/auto/xar
	name = "Carwo XAR-10"
	desc = "Тяжелая боевая винтовка в компоновке булл-пап, стреляющая патронами калибра .40 Sol. Часто встречается в руках военных ТСФ. Принимает любой стандартный магазин от винтовок ТСФ."
	icon_state = "xar10"
