...
/obj/item/gun/ballistic/automatic/bogseo/examine_more(mob/user)
	. = ..()
	. += "Пистолет-пулемёт Bogseo воспринимается по-разному в зависимости от того, \
		кого вы спросите. Спросите жителя Юпитера, и он будет весь день рассказывать, как он \
		любит это оружие. Большое оружие для стрельбы по большим целям, таким как \
		налетчики-топливщики в своих больших доспехах. Однако спросите космического пирата, и вы услышите совсем другую историю. \
		Это благодаря тому, что многие антипиратские подразделения ТСФ выбрали Богсео в качестве своего стандартного оружия для абордажа. \
