...
/obj/item/gun/ballistic/revolver/takbok
	...
	desc = "Массивный револьвер с не менее массивным барабаном, вмещающим пять патронов калибра .585 Trappiste."
...
/obj/item/gun/ballistic/revolver/takbok/examine_more(mob/user)
	. = ..()
	. += "Takbok — уникальная разработка по той единственной причине, что изначально он был создан как единичный экземпляр. \
