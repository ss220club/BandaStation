...
/obj/item/gun/ballistic/revolver/eland/examine_more(mob/user)
	. = ..()
	. += "Eland — одно из немногих оружий Trappiste, не изготовленных по военному контракту. \
		Вместо этого Eland начал свою жизнь как полицейское оружие, предлагаемое в качестве пистолета, \
		...
		рынок, Eland вместо этого нашел свое место на рынке гражданского оружия для личной защиты. \
