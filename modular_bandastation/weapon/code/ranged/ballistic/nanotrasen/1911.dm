...
/obj/item/gun/ballistic/automatic/pistol/m1911/m45a5
	name = "M45A5 'Rowland'"
	desc = "Модернизированная версия легендарного M1911 в калибре .456 Magnum, в настоящее время широко распространенный среди высокопоставленных сотрудников Нанотрейзен."
	icon_state = "m45a5"
