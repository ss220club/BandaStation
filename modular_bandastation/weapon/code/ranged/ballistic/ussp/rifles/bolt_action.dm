...
/obj/item/gun/ballistic/rifle/krov/add_deep_lore()
	AddElement(/datum/element/examine_lore, \
		lore = "Винтовка \"Ворон\" является модификацией известной винтовки Сахно, обладающей \"современными\" характеристиками, такими как направляющие для аксессуаров и съемные магазины. <br>\
...
/obj/item/gun/ballistic/rifle/sks/add_deep_lore()
	AddElement(/datum/element/examine_lore, \
		lore = "Эта винтовка должна была заменить Сахно, но была остановлена появлением боевых винтовок Ланка. Это оружие заняло уникальное место в истории среди населения союза. \
		...
		Пограничные поселенцы известны тем, что владеют таким оружием для охоты или для отражения назойливых врагов народа.")
...
/obj/item/gun/ballistic/rifle/sks/c762x54mmr
	...
	desc = parent_type::desc + "<br>Этот вариант винтовки еще более редкий, так как не был переделан под новый калибр .310 Стрилка. \
		Кто знает, может быть это даже раритетный оригинал."
