...
/obj/item/gun/ballistic/automatic/miecz/add_deep_lore()
	AddElement(/datum/element/examine_lore, \
		lore = "Штурмовая винтовка AMC-874 \"Мечь\", это усовершенствованная конструкция на основе прошлых образцов по типу автомата АМК. \
