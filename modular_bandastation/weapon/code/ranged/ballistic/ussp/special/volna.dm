...
/obj/item/gun/ballistic/automatic/volna/add_deep_lore()
	AddElement(/datum/element/examine_lore, \
		lore = "Тяжелый пулемет Волна-12 был разработан Оборонной Коллегией СССП в середине 26 века как замена устаревшему пулемету образца ДКШ. <br>\
...
/obj/item/gun/ballistic/automatic/volna/click_alt_secondary(mob/user)
...
/obj/item/gun/ballistic/automatic/volna/process_fire(atom/target, mob/living/user, message = TRUE, params = null, zone_override = "", bonus_spread = 0)
	if(cover_open)
...
/obj/item/gun/ballistic/automatic/volna/insert_magazine(mob/user, obj/item/ammo_box/magazine/AM, display_message = TRUE)
