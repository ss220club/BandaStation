...
/obj/item/gun/ballistic/revolver/dvoystvol/add_deep_lore()
	AddElement(/datum/element/examine_lore, \
		lore = "Револьвер Двоствол-7 был разработан Оборонной Коллегией СССП в конце 26 века как уникальное оружие для элитных подразделений. \
