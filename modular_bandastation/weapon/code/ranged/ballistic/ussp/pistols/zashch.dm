...
/obj/item/gun/ballistic/automatic/pistol/zashch/add_deep_lore()
	AddElement(/datum/element/examine_lore, \
		lore = "Самозарядный пистолет \"Защитник\" — это мощный пистолет, в котором основное внимание уделено надежности и емкости магазина. <br>\
