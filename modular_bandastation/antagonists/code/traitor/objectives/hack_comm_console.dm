...
/datum/traitor_objective/hack_comm_console
	name = "Взломайте коммуникационную консоль чтобы вызвать неизвестную угрозу на станцию"
	...
	progression_reward = list(45 MINUTES, 55 MINUTES)
	telecrystal_reward = list(8, 14)
