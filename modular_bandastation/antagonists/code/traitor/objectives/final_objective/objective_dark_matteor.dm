...
/obj/item/paper/dark_matteor_summoning
	...
	default_raw_text = {"
		...
		<br>
		<br>
		Оперативник, этот ящик содержит 10+1(1 запасной) спуников против метеоритов украденных с логистической цепи НТ. Твоя миссия заключается
		...
		у тебя есть 5 минут работы, и 1 минута после того как об тебе сообщит ЦК НТ.<br>
		<br>
...
/obj/item/card/emag/meteor_shield_recalibrator
	...
	desc = "Это ЕМАГ, который настроен на более эффективное перепрограммирование метеоритных спутников."
