/datum/traitor_objective/ultimate/infect_ai
	name = "Заразить станционный ИИ эксперементальным вирусом."
	description = "Заразите станционный ИИ эксперементальным вирусом. Отправляйтесь в %AREA% чтобы получить плату с вирусом, \
		а потом загрузите эти законы в ИИ любым удобным вас способом."
...
/datum/traitor_objective/ultimate/infect_ai/generate_ui_buttons(mob/user)
	...
	if(!sent_board)
		buttons += add_ui_button("", "Нажатие на кнопку вызовет капсулу с платой на которой установлен вирус.", "wifi", "upload_board")
	return buttons
