...
/obj/item/paper/calling_card
	...
	<b>SELF:</b> Они борятся за защиту и свободу кремневой жизни по всей галактике.<br><br>

	<b>Tiger Cooperative:</b> Они борятся за свободу своей веры.<br><br>

	<b>Waffle Corporation:</b> Они борятся за возвращение здоровой корпоративной конкуренции, приглушённой монополией НТ.<br><br>
