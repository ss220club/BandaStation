...
/datum/antagonist/bloodsucker/proc/give_warning(atom/source, danger_level, vampire_warning_message, vassal_warning_message)
	...
	switch(danger_level)
		if(DANGER_LEVEL_FIRST_WARNING)
			owner.current.playsound_local(null, 'modular_bandastation/antagonists/code/bloodsuckers_220/bloodsuckers/sounds/griffin_3.ogg', 50, 1)
		if(DANGER_LEVEL_SECOND_WARNING)
			owner.current.playsound_local(null, 'modular_bandastation/antagonists/code/bloodsuckers_220/bloodsuckers/sounds/griffin_5.ogg', 50, 1)
