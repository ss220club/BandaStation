...
/obj/structure/bloodsucker/bloodthrone
	...
	icon = 'modular_bandastation/antagonists/code/bloodsuckers_220/icons/bloodsuckers/vamp_obj_64.dmi'
	icon_state = "throne"
	buckle_lying = 0
	anchored = FALSE
	density = TRUE
...
/obj/structure/bloodsucker/bloodthrone/Initialize()
	...
	if(!armrest)
		armrest = mutable_appearance('modular_bandastation/antagonists/code/bloodsuckers_220/icons/bloodsuckers/vamp_obj_64.dmi', "thronearm")
...
/obj/structure/bloodsucker/mirror/Initialize(mapload)
	. = ..()
	var/static/list/reflection_filter = alpha_mask_filter(icon = icon('modular_bandastation/antagonists/code/bloodsuckers_220/icons/bloodsuckers/vamp_obj.dmi', "blood_mirror_mask"))
