/datum/action/cooldown/bloodsucker
	...
	background_icon = 'modular_bandastation/antagonists/code/bloodsuckers_220/icons/bloodsuckers/actions_bloodsucker.dmi'
	background_icon_state = "vamp_power_off"
	button_icon = 'modular_bandastation/antagonists/code/bloodsuckers_220/icons/bloodsuckers/actions_bloodsucker.dmi'
...
/datum/action/cooldown/bloodsucker/process(seconds_per_tick)
	...
	else if(!(power_flags & BP_AM_COSTLESS_UNCONSCIOUS))
		bloodsuckerdatum_power?.AddBloodVolume(-constant_bloodcost)
	return TRUE
