 ...
 */
ADMIN_VERB(change_title_screen, R_SERVER, "Лобби: Изменить изображение", ADMIN_VERB_NO_DESCRIPTION, ADMIN_CATEGORY_EVENTS)
 ...
 */
ADMIN_VERB(change_title_screen_notice, R_SERVER, "Лобби: Изменить уведомление", ADMIN_VERB_NO_DESCRIPTION, ADMIN_CATEGORY_EVENTS)
	if(!check_rights(R_SERVER))
		return
