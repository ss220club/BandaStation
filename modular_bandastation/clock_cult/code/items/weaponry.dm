...
/obj/item/clockwork/weapon
	...
	desc = "Something"
	icon = 'modular_bandastation/clock_cult/icons/obj/clock_cult/clockwork_weapons.dmi'
	lefthand_file = 'modular_bandastation/clock_cult/icons/mob/clock_cult/clockwork_lefthand.dmi'
	righthand_file = 'modular_bandastation/clock_cult/icons/mob/clock_cult/clockwork_righthand.dmi'
	worn_icon = 'modular_bandastation/clock_cult/icons/mob/clock_cult/clockwork_garb_worn.dmi'
...
/obj/item/clockwork/weapon/Initialize(mapload)
	. = ..()
	// turf_checker component not in BandaStation; on-brass-tile weapon effects disabled
...
/datum/action/cooldown/spell/summon_spear
	...
	button_icon = 'modular_bandastation/clock_cult/icons/obj/clock_cult/clockwork_weapons.dmi'
	button_icon_state = "ratvarian_spear0"
	background_icon = 'modular_bandastation/clock_cult/icons/mob/clock_cult/background_clock.dmi'
...
/obj/item/gun/ballistic/bow/clockwork
	...
	drawn = TRUE
	/// Monkestation var preventing forced drops; declared locally (no effect in BandaStation)
	var/nodrop = TRUE
...
/obj/item/gun/ballistic/bow/clockwork/Initialize(mapload)
	...
	// turf_checker component not in BandaStation; bow brass-tile recharge bonus disabled
...
/obj/item/ammo_casing/arrow/clockbolt
	...
	icon = 'modular_bandastation/clock_cult/icons/obj/clock_cult/ammo.dmi'
	icon_state = "arrow_redlight"
	projectile_type = /obj/projectile/energy/clockbolt

/obj/projectile/energy/clockbolt
	name = "energy bolt"
	icon = 'modular_bandastation/clock_cult/icons/obj/clock_cult/projectiles.dmi'
