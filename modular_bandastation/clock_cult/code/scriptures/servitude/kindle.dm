...
/datum/scripture/slab/kindle/apply_effects(mob/living/hit_mob)
	...
	if(issilicon(hit_mob))
		...
		// adjust_emote_mute not available in BandaStation
...
// Martial arts counter/dodge handler; mind.martial_art and eepy_carp.counter not available in BandaStation
