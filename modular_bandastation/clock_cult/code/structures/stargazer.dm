...
/obj/structure/destructible/clockwork/gear_base/stargazer/proc/upgrade_weapon(obj/item/upgraded_item, mob/living/user)
	// datum/component/enchanted and attempt_enchantment() not available in BandaStation; enchantment is disabled
	to_chat(user, span_brass("The stargazer hums with energy, but the enchantment system is unavailable in this realm."))
	return FALSE
