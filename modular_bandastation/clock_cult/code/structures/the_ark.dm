...
/obj/structure/destructible/clockwork/the_ark/deconstruct(disassembled = TRUE)
	...
	ASYNC
		if(!disassembled)
			...
			sound_to_playing_players('modular_bandastation/clock_cult/sound/effects/explosion_distant.ogg', 50)
...
/obj/structure/destructible/clockwork/the_ark/take_damage(damage_amount, damage_type, damage_flag, sound_effect, attack_dir, armour_penetration)
	...
	if(!.)
		return
	send_clock_message(span_bigbrass("The ark is taking damage!"), sent_sound = 'modular_bandastation/clock_cult/sound/effects/ark_damage.ogg')
	flick("clockwork_gateway_damaged", src)
	playsound(src, 'modular_bandastation/clock_cult/sound/effects/ark_damage.ogg', 75, FALSE)
...
/obj/structure/destructible/clockwork/the_ark/process(seconds_per_tick)
	...
	if(current_state < ARK_STATE_SUMMONING && charging_for >= (ARK_ASSAULT_PERIOD * 0.5))
		...
		sound_to_playing_players('modular_bandastation/clock_cult/sound/effects/clockcult_gateway_closing.ogg', 30, TRUE)
...
/obj/structure/destructible/clockwork/the_ark/proc/announce_gateway()
	send_clock_message(span_ratvar("DESTROY THE HERETICS."), sent_sound = 'modular_bandastation/clock_cult/sound/effects/ark_recall.ogg')
	sleep(3 SECONDS)
	...
	// turf_demolisher/reebe not available in BandaStation; no supply drop at ark activation
	...
	sound_to_playing_players('modular_bandastation/clock_cult/sound/effects/clockcult_gateway_charging.ogg', 10, TRUE)
...
/obj/structure/destructible/clockwork/the_ark/proc/summon_ratvar()
	...
	sound_to_playing_players('modular_bandastation/clock_cult/sound/effects/ratvar_rises.ogg', 100)
