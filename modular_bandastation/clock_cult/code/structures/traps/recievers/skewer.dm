...
/obj/structure/destructible/clockwork/trap/skewer/proc/stab()
	...
	if(target_stabbed)
		if(!stab_overlay)
			stab_overlay = mutable_appearance('modular_bandastation/clock_cult/icons/obj/clock_cult/clockwork_objects.dmi', "brass_skewer_pokeybit", layer = ABOVE_MOB_LAYER)
