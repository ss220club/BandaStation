...
/obj/structure/destructible/clockwork/gear_base/powered/ocular_warden/process(delta_time)
	...
	playsound(src, 'modular_bandastation/clock_cult/sound/effects/ocularwarden_target.ogg', 60, TRUE)
	...
	playsound(target, 'modular_bandastation/clock_cult/sound/effects/ocularwarden_dot1.ogg', 60, TRUE)
