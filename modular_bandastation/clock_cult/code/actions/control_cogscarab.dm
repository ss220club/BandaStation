/datum/action/control_host/cogscarab
	...
	button_icon = 'modular_bandastation/clock_cult/icons/obj/clock_cult/clockwork_objects.dmi'
...
/datum/action/return_to_overlord/cogscarab
	button_icon = 'modular_bandastation/clock_cult/icons/obj/clock_cult/clockwork_effects.dmi'
