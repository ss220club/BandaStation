/datum/action/innate/clockcult
	button_icon = 'modular_bandastation/clock_cult/icons/mob/clock_cult/actions_clock.dmi'
...
/datum/action/item_action/toggle/clock
	button_icon = 'modular_bandastation/clock_cult/icons/mob/clock_cult/background_clock.dmi'
	background_icon_state = "bg_clock"
