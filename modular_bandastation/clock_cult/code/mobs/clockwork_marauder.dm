...
/mob/living/basic/clockwork_marauder
	...
	icon = 'modular_bandastation/clock_cult/icons/mob/clock_cult/clockwork_mobs.dmi'
...
// /datum/element/bane not in BandaStation; nullrod holy-weapon effect against marauders skipped
