...
/obj/machinery/vending/snack/ollfoods
	...
	icon = 'modular_bandastation/objects/icons/obj/machines/vending.dmi'
	icon_state = "ollfoods"
	product_slogans = "Яблоки, груши и многое другое!;В пять раз больше витаминов!;Лучше переплатить за еду, чем платить за лечение!"
	product_ads = "Свежее!;Натуральное!;С любовью из Ол Корп;Прямо с грядки;Настоящий вкус;Приготовь сам!;Последний урожай!"
	products = list(
