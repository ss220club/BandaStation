...
var/static/list/hacking_alerts = list(
	...
	"Спасибо за поддержку нашего вульпинского благотворительного фонда. Ваш перевод одобрен.",
	"Оплата за услуги троллинга пострадавших от космо-мошенников была списана. Спасибо за внимание.",
	"Ваши дивиденты от инвестиций в акции Donk Co. были успешно переведены на ваш счёт. Спасибо за внимание.",
