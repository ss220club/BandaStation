...
/obj/item/clothing/accessory/holster/Entered(atom/movable/I)
	...
	if(istype(I, /obj/item/gun))
		playsound(src, 'modular_bandastation/weapon/sound/ranged/holsterin.ogg', 50, TRUE)

/obj/item/clothing/accessory/holster/Exited(atom/movable/I)
	. = ..()

	if(istype(I, /obj/item/gun))
		playsound(src, 'modular_bandastation/weapon/sound/ranged/holsterout.ogg', 50, TRUE)
