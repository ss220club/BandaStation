...
// USSP - пока тут, что бы без конфликтов с другим ТМом

/datum/mod_theme/ussp_standart
	name = "SPETSNAZ regular"
	desc = "Боевой МОД Спецназа КА СССП."
	extended_desc = "Модульный бронекостюм, который носят бойцы спецназа Главного Разведывательного Управления Союза Советских Социалистических Планет.\
