...
/obj/item/organ/cyberimp/arm/centcom
...
/obj/item/organ/cyberimp/arm/custom/attackby(obj/item/I, mob/user, params)
...
/obj/item/organ/cyberimp/arm/custom/on_mob_remove(mob/living/carbon/arm_owner)
	if(active_item)
		Retract()
	return ..()
