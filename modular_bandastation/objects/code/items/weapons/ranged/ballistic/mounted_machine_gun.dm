...
/obj/machinery/mounted_machine_gun
	...
	icon = 'modular_bandastation/objects/icons/obj/weapons/guns/turret.dmi'
	icon_state = "mmg"
	base_icon_state = "mmg"
	can_buckle = TRUE
	anchored = FALSE
	...
	var/firesound = 'modular_bandastation/objects/sounds/weapons/50cal_box_01.ogg'
...
/obj/machinery/mounted_machine_gun/proc/toggle_cover(mob/user)
	...
	playsound(src, cover_open ? 'modular_bandastation/objects/sounds/weapons/open_lid.ogg' : 'modular_bandastation/objects/sounds/weapons/close_lid.ogg', 100)
...
/obj/machinery/mounted_machine_gun/proc/cock_bolt()
	if(bolt)
		return
	bolt = TRUE
	playsound(src, 'modular_bandastation/objects/sounds/weapons/cock_bolt.ogg', 100)
...
/obj/item/mounted_machine_gun_folded
	...
	icon = 'modular_bandastation/objects/icons/obj/weapons/guns/turret_objects.dmi'
