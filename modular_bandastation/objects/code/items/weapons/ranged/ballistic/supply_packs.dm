...
/datum/supply_pack/goody/gp9_mags_extended_single
	...
	desc = "Не хватает патронов в магазине? B этом ящике находится один увеличенный магазин калибра 9x25мм НТ."
...
/datum/supply_pack/goody/gp9_single
	...
	desc = "Вам нужен новый пистолет? В этом ящике вы найдете себе один пистолет GP-9 калибра 9x25мм НТ с пустым магазином."
	cost = CARGO_CRATE_VALUE * 6
	access_view = ACCESS_WEAPONS
	contains = list(
...
/datum/supply_pack/goody/c9x25mmrubber
	...
	desc = "Нужны нелетальные патроны? В этом ящике находится коробка резиновых патронов калибра 9x25мм НТ."
...
/datum/supply_pack/goody/c9x25mmhp
	...
	desc = "Нужны экспансивные патроны? В этом ящике находится коробка с экспансивными патронами калибра 9x25мм НТ."
	cost = CARGO_CRATE_VALUE * 2
	access_view = ACCESS_WEAPONS
	contains = list(
		/obj/item/ammo_box/c9x25mm/hp = 1,
...
/datum/supply_pack/goody/c9x25mmap
	...
	desc = "Нужны бронебойные патроны? В этом ящике находится коробка с бронебойными патронами калибра 9x25мм НТ."
	cost = CARGO_CRATE_VALUE * 2
	access_view = ACCESS_WEAPONS
	contains = list(
		/obj/item/ammo_box/c9x25mm/ap = 1,
...
/datum/supply_pack/goody/c9x25mm
	...
	desc = "Нужны летальные патроны? В этом ящике находится коробка с летальными патронами калибра 9x25мм НТ."
	cost = CARGO_CRATE_VALUE * 2
	access_view = ACCESS_WEAPONS
	contains = list(
		/obj/item/ammo_box/c9x25mm = 1,
