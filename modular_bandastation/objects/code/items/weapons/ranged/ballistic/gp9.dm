/obj/item/gun/ballistic/automatic/pistol/gp9
	name = "GP-9"
	desc = "Стандартный служебный пистолет общего назначения под малоимпульсные патроны калибра 9x25mm НТ."
...
/obj/item/gun/ballistic/automatic/pistol/gp9/examine_more(mob/user)
	...
	под малоимпульсные калибра 9x25мм. Данный пистолет был создан для использования отделами \
...
/obj/item/gun/ballistic/automatic/pistol/gp9/spec
	name = "GP-93R"
	desc = "Стандартный служебный пистолет общего назначения под малоимпульсные патроны калибра 9x25mm НТ. Специальный вариант с возможностью вести автоматический огонь."
	icon_state = "gp93r"
	spread = 10
...
/obj/item/gun/ballistic/automatic/pistol/gp9/spec/examine_more(mob/user)
	...
	и улучшенной эргономикой. Данный вариант был разработан для использования корпоративными спец службами НаноТрейзен."
