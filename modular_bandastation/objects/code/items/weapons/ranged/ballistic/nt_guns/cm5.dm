/obj/item/gun/ballistic/automatic/cm5
	...
	fire_sound = 'modular_bandastation/objects/sounds/weapons/cm5.ogg'
	can_suppress = TRUE
	burst_size = 1
	...
	load_sound = 'modular_bandastation/objects/sounds/weapons/cm5_reload.ogg'
	load_empty_sound = 'modular_bandastation/objects/sounds/weapons/cm5_reload.ogg'
	eject_sound = 'modular_bandastation/objects/sounds/weapons/cm5_unload.ogg'
	eject_empty_sound = 'modular_bandastation/objects/sounds/weapons/cm5_unload.ogg'
...
/obj/item/gun/ballistic/automatic/cm5/examine_more(mob/user)
	...
	службы безопастности и группами быстрого реагирования на обьектах Нанотрейзен во всех возможных условиях, в которых обычно работает НТ, \
