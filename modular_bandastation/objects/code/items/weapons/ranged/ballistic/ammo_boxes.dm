...
/obj/item/ammo_box/c35sol/rubber
	...
	desc = "Коробка с нелетальными пистолетными патронами калибра .35 Sol Short, вмещает 24 патрона. Синяя полоска указывает на то, что здесь должны храниться нелетальные боеприпасы."
...
/obj/item/ammo_box/c40sol/fragmentation
	...
	desc = "Коробка с винтовочными патронами калибра .40 Sol Long, вмещает 30 патронов. Синяя полоска указывает на то, что здесь должны храниться нелетальные боеприпасы."
...
/obj/item/ammo_box/c9x25mm/rubber
	...
	desc = "Коробка с нелетальными пистолетными патронами калибра 9x25мм НТ, вмещает 24 патрона. Синяя полоска указывает на то, что здесь должны храниться нелетальные боеприпасы."
	icon_state = "35box_disabler"
