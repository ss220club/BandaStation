...
/obj/item/kinetic_crusher/machete
	...
	desc = "Недавние достижения в области технологии прото-кинетики привели к усовершенствованию конструкции ранних прото-кинетических крашеров, а именно — к возможности уместить все те же \
	технологии в компактную форму. Форма мачете была выбрана так, чтобы сделать крашер гораздо более простым в обращении и менее громоздким. Конечно, \
...
/obj/item/kinetic_crusher/spear
	...
	мы смогли поместить всё это в форму копья. Прото-кинетические крашеры больше не будут предназначены для самых опытных и склонных к самоубийству шахтёров, но теперь они также будут доступны самым осторожным \
	и параноидальным шахтёрам, которые смогут наслаждаться меньшей мощностью крашера, сохраняя при этом минимальную безопасную дистанцию."
	force = 0
...
/obj/item/kinetic_crusher/hammer
	...
	desc = "Каким-то образом отдел исследований и разработок, смог сделать прототип прото-кинетического крашера еще больше, что позволило разместить внутри большее количество деталей и увеличить выходную мощность.. \
	...
	не даёт возможность наносить больше урона атакуя спину."
	force = 0
	w_class = WEIGHT_CLASS_HUGE
	slot_flags = ITEM_SLOT_BACK
	throwforce = 5
...
/obj/item/kinetic_crusher/claw
	...
	Лучше всего использовать его при атаке сзади, награждая тех, кто способен нанести так называемый 'критический удар'. \
