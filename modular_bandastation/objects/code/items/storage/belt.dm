...
/obj/item/storage/belt/military/army/tsf/full_pistol_skild/PopulateContents()
	new /obj/item/gun/ballistic/automatic/pistol/skild(src)
	new /obj/item/ammo_box/magazine/c585sol(src)
	new /obj/item/ammo_box/magazine/c585sol(src)
	new /obj/item/ammo_box/magazine/c585sol(src)
	new /obj/item/ammo_box/magazine/c585sol/ap(src)
	new /obj/item/ammo_box/magazine/c585sol/ap(src)

/obj/item/storage/belt/military/army/tsf/full_revolver_takbok/PopulateContents()
	new /obj/item/gun/ballistic/revolver/takbok/army(src)
	new /obj/item/ammo_box/speedloader/a50ae_cylinder(src)
	new /obj/item/ammo_box/speedloader/a50ae_cylinder(src)
	new /obj/item/ammo_box/speedloader/a50ae_cylinder(src)
	new /obj/item/ammo_box/speedloader/a50ae_cylinder(src)
	new /obj/item/ammo_box/speedloader/a50ae_cylinder(src)
	new /obj/item/melee/baton/telescopic/silver(src)

/obj/item/storage/belt/military/army/tsf/full_minigun/PopulateContents()
	new /obj/item/gun/ballistic/automatic/pistol/skild(src)
	new /obj/item/ammo_box/magazine/c585sol/extended(src)
	new /obj/item/ammo_box/magazine/c585sol/extended/ap(src)
...
/obj/item/storage/belt/military/army/tsf/full_smg_vektor/PopulateContents()
	new /obj/item/ammo_box/magazine/smgm9mm/ap(src)
	new /obj/item/ammo_box/magazine/smgm9mm/ap(src)
	new /obj/item/ammo_box/magazine/smgm9mm/fire(src)
	new /obj/item/ammo_box/magazine/smgm9mm/fire(src)
	new /obj/item/ammo_box/c12ga/milspec(src)
	new /obj/item/ammo_box/c12ga/slug(src)
	new /obj/item/ammo_box/c12ga/breacher(src)

/obj/item/storage/belt/military/army/tsf/full_smg_bogseo/PopulateContents()
	new /obj/item/gun/ballistic/revolver/takbok(src)
	new /obj/item/ammo_box/speedloader/a50ae_cylinder(src)
	new /obj/item/ammo_box/speedloader/a50ae_cylinder(src)
	new /obj/item/ammo_box/magazine/c585sol/extended/ap(src)
	new /obj/item/ammo_box/magazine/c585sol/extended/ap(src)
	new /obj/item/ammo_box/magazine/c585sol/extended/incendiary(src)
...
/obj/item/storage/belt/military/army/tsf/full_autorifle_hydra/PopulateContents()
	new /obj/item/gun/ballistic/automatic/pistol/wespe(src)
	new /obj/item/ammo_box/magazine/c35sol_pistol/stendo(src)
	new /obj/item/ammo_box/magazine/c35sol_pistol/stendo(src)
	new /obj/item/ammo_box/magazine/c223(src)
	new /obj/item/ammo_box/magazine/c223(src)
	new /obj/item/ammo_box/magazine/c223(src)
	new /obj/item/ammo_box/magazine/c223(src)

/obj/item/storage/belt/military/army/tsf/full_autorifle_hydra_officer/PopulateContents()
	new /obj/item/gun/ballistic/automatic/pistol/skild/army(src)
	new /obj/item/ammo_box/magazine/c585sol/extended(src)
	new /obj/item/ammo_box/magazine/c585sol/extended/ap(src)
	new /obj/item/ammo_box/magazine/c223(src)
	new /obj/item/ammo_box/magazine/c223(src)
	new /obj/item/ammo_box/magazine/c223/ap(src)
	new /obj/item/ammo_box/magazine/c223/ap(src)

/obj/item/storage/belt/military/army/tsf/full_autorifle_cr13_marsok/PopulateContents()
	new /obj/item/gun/ballistic/revolver/takbok(src)
	new /obj/item/ammo_box/speedloader/a50ae_cylinder(src)
	new /obj/item/ammo_box/speedloader/a50ae_cylinder(src)
	new /obj/item/ammo_box/magazine/c223/ap(src)
	new /obj/item/ammo_box/magazine/c223/phasic(src)
	new /obj/item/ammo_box/magazine/c223/hp(src)
	new /obj/item/ammo_box/magazine/c223/incendiary(src)
...
/obj/item/storage/belt/military/army/tsf/full_gl/PopulateContents()
	new /obj/item/gun/ballistic/automatic/pistol/wespe(src)
	new /obj/item/ammo_box/magazine/c35sol_pistol/stendo(src)
	new /obj/item/ammo_box/magazine/c35sol_pistol/stendo(src)
	new /obj/item/ammo_box/magazine/c980_grenade/drum/shrapnel(src)
	new /obj/item/ammo_box/magazine/c980_grenade/drum/phosphor(src)
	new /obj/item/ammo_box/magazine/c980_grenade/drum/gas(src)
	new /obj/item/ammo_box/magazine/c980_grenade/drum/smoke(src)

/obj/item/storage/belt/military/army/tsf/full_sniper_hydra/PopulateContents()
	new /obj/item/gun/ballistic/automatic/pistol/skild/army(src)
	new /obj/item/ammo_box/magazine/c585sol(src)
	new /obj/item/ammo_box/magazine/c585sol(src)
	new /obj/item/ammo_box/magazine/c585sol(src)
...
/obj/item/storage/belt/military/army/tsf/full_sniper_heavy/PopulateContents()
	...
	new /obj/item/ammo_box/magazine/sniper_rounds/marksman(src)
