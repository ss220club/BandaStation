// Override: build lobby HTML using SStitle.title_html (hybrid default = trainstation CSS from title_defines).
// Same structure as modular_skyrat title_screen_html.dm; SStitle is provided by title_subsystem.dm.
