// Default CSS/layout for hybrid SStitle (from modular_zvents trainstation ~custom_tittle.dm).
// Overrides modular_skyrat title_screen defines so the lobby uses this style by default.
