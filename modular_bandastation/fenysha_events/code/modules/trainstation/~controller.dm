...
/datum/controller/subsystem/train_controller/proc/show_station_logo(datum/train_station/station, silent = FALSE)
	for(var/mob/player in GLOB.player_list)
		if(!silent)
			SEND_SOUND(player, 'modular_bandastation/fenysha_events/sounds/effects/station_logo.ogg')
...
/datum/controller/subsystem/train_controller/proc/start_moving(force = FALSE, unload_station = TRUE)
	...
	soundloop.start()
	sound_to_playing_players('modular_bandastation/fenysha_events/sounds/steam_short.ogg', volume = 60)
	tain_starting = FALSE
...
/datum/controller/subsystem/train_controller/proc/stop_moving()
	...
	sound_to_playing_players('modular_bandastation/fenysha_events/sounds/steam_long.ogg', volume = 60)
	if(no_engine_mode)
...
/datum/looping_sound/global_sound/train_sound_loop
	sounds_to_play = list(
		'modular_bandastation/fenysha_events/sounds/loop_trainride.ogg' = 63 SECONDS,
	)
