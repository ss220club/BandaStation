/datum/outfit/job/ussp_chemist
	name = "Аптекарь"
	id = /obj/item/card/id/advanced
	id_trim = /datum/id_trim/job/ussp_chemist
...
/datum/job/ussp_chemist
	title = "Аптекарь"
	supervisors = "главным врачом"
	description = "Готовьте лекарства и препараты. Попутно приторговывайте крокодилом."
	departments_list = list(
		/datum/job_department/medical,
	)
	outfit = /datum/outfit/job/ussp_chemist
...
/datum/id_trim/job/ussp_chemist
	assignment = "Аптекарь"
