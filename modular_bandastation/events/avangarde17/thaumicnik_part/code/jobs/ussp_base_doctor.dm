...
/datum/job/ussp_base_medic
	...
	total_positions = 2
	spawn_positions = 2
	event_description = "Вам удалось дослужиться до звания младшего офицера и теперь в вашем распоряжении небольшой отряд или целый взвод, которые будут исполнять ваши приказы! Обязательно посетите политпросвет в основном здании военной базы и получите задачи у коменданта части или замполита. Обязательно наведайтесь к прапору для инвентаризации. Все недостающие или нужные материалы, ресурсы, патроны или оружие вы можете заказать через факс в диспетчерской, на втором этаже склада"
