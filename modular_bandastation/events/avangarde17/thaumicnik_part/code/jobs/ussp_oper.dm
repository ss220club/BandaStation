...
/datum/job/ussp_oper
	title = "Оперуполномоченный"
	supervisors = "Райкомом"
	...
	outfit = /datum/outfit/job/ussp_oper
...
/datum/id_trim/job/ussp_oper
	assignment = "Оперуполномоченный"
