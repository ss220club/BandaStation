...
/datum/spell_handler/proc/can_cast(mob/user, charge_check, show_message, datum/action/cooldown/spell)
	return TRUE

/datum/spell_handler/proc/spend_spell_cost(mob/user, datum/action/cooldown/spell)
	return

/datum/spell_handler/proc/revert_cast(mob/user, datum/action/cooldown/spell)
	return

/datum/spell_handler/proc/before_cast(list/targets, mob/user, datum/action/cooldown/spell)
	return
