...
/datum/action/cooldown/spell/vampire/self/cloak/proc/update_spell_name(mob/living/user)
...
/datum/action/cooldown/spell/vampire/self/cloak/cast(list/targets, mob/user = usr)
	var/datum/antagonist/vampire/V = user.mind.has_antag_datum(/datum/antagonist/vampire)
...
/datum/action/cooldown/spell/vampire/shadow_snare/create_new_targeting()
	var/datum/spell_targeting/click/T = new
	T.allowed_type = /turf/simulated
	T.click_radius = -1
	return T

/datum/action/cooldown/spell/vampire/shadow_snare/cast(list/targets, mob/user)
...
/datum/action/cooldown/spell/vampire/soul_anchor/create_new_targeting()
	return new /datum/spell_targeting/self

/datum/action/cooldown/spell/vampire/soul_anchor/cast(list/targets, mob/user)
...
/datum/action/cooldown/spell/vampire/soul_anchor/proc/make_anchor(mob/user, turf/anchor_turf)
	anchor = new(anchor_turf)
	timer = addtimer(CALLBACK(src, PROC_REF(recall), user, TRUE), 2 MINUTES, TIMER_STOPPABLE)

/datum/action/cooldown/spell/vampire/soul_anchor/proc/recall(mob/user, fake = FALSE)
...
/datum/action/cooldown/spell/vampire/dark_passage/create_new_targeting()
	var/datum/spell_targeting/click/T = new
	T.click_radius = 0
	T.allowed_type = /turf/simulated
	return T

/datum/action/cooldown/spell/vampire/dark_passage/cast(list/targets, mob/user)
...
/datum/action/cooldown/spell/vampire/vamp_extinguish/create_new_targeting()
	var/datum/spell_targeting/aoe/turf/T = new
	return T

/datum/action/cooldown/spell/vampire/vamp_extinguish/cast(list/targets, mob/user = usr)
...
/datum/action/cooldown/spell/vampire/shadow_boxing/create_new_targeting()
...
/datum/action/cooldown/spell/vampire/shadow_boxing/cast(list/targets, mob/user)
...
/datum/action/cooldown/spell/vampire/self/eternal_darkness/cast(list/targets, mob/user)
	var/datum/antagonist/vampire/V = user.mind.has_antag_datum(/datum/antagonist/vampire)
