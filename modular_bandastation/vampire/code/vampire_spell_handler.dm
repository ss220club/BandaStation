...
/datum/spell_handler/vampire/can_cast(mob/user, charge_check, show_message, datum/action/cooldown/spell)
...
/datum/spell_handler/vampire/spend_spell_cost(mob/user, datum/action/cooldown/spell)
...
/datum/spell_handler/vampire/after_cast(list/targets, mob/user, datum/action/cooldown/spell)
