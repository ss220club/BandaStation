...
/datum/component/stamina_cost_per_hit/Initialize(
	...
	src.stamina_cost_wielded = (!isnull(stamina_cost_wielded) && (stamina_cost_wielded >= 0)) ? stamina_cost_wielded : stamina_cost
	src.stamina_cost_on_atom = (!isnull(stamina_cost_on_atom) && (stamina_cost_on_atom >= 0)) ? stamina_cost_on_atom : stamina_cost
	src.stamina_cost_wielded_on_atom = (!isnull(stamina_cost_wielded_on_atom) && (stamina_cost_wielded_on_atom >= 0)) ? stamina_cost_wielded_on_atom : src.stamina_cost_wielded
