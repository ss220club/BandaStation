...
#define REDSPACE_DEMON_AGGRO_RANGE 16
#define REDSPACE_DEMON_TARGET_LOSS_DISTANCE 32
...
#define REDSPACE_RIFT_SCANNER_SCAN_INTERVAL (5 MINUTES)
...
#define REDSPACE_STABILIZER_DEFAULT_RADIUS 10
...
/// Unattended hotspots slowly become harder to contain.
#define REDSPACE_HOTSPOT_GROWTH_INTERVAL (1 MINUTES)
#define REDSPACE_HOTSPOT_STRENGTH_GROWTH_PER_MINUTE 0.2
#define REDSPACE_HOTSPOT_RADIUS_GROWTH_PER_MINUTE 0.5

/// Rift sealers must be installed close to a hotspot and hold the seal for a while.
...
#define REDSPACE_RIFT_SEALING_EVENT_FREQUENCY_MULTIPLIER 2
