...
/obj/item/robot_model/engineering
	borg_skins = list(
		...
		"Eyebot" = list(SKIN_ICON_STATE = "eyeboteng", SKIN_ICON = CYBORG_ICON_ENG),
...
/obj/item/robot_model/medical
	borg_skins = list(
		...
		"Eyebot" = list(SKIN_ICON = CYBORG_ICON_MED, SKIN_ICON_STATE = "eyebotmed"),
...
/obj/item/robot_model/janitor
	borg_skins = list(
		...
		"Eyebot" = list(SKIN_ICON_STATE = "eyebotjani", SKIN_ICON = CYBORG_ICON_JANI),
...
/obj/item/robot_model/miner
	...
	borg_skins = list(
		...
		"Droid" = list(SKIN_ICON_STATE = "miner", SKIN_ICON = CYBORG_ICON_MINING, SKIN_HAT_OFFSET = list("north" = list(0, 4), "south" = list(0, 4), "east" = list(0, 4), "west" = list(0, 4))),
