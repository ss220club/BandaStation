...
/datum/species/vox/get_physical_attributes()
	...
	Тело покрыто жёсткими кератиновыми чешуйками, под которыми располагается кожа, а на голове и иногда конечностях растут яркие перья. \
...
/datum/species/vox/get_species_description()
	return "Вид искусственно созданных прямоходящих гуманоидов, происходящих с космических кораблей, известных как Ковчеги. \
