...
// ============================================
// БОНУС ХИРУРГА: GEN I МЕДИЦИНСКИЙ МОДУЛЬ
// ============================================
// TRAIT_MEDICAL_ACES даёт -25% времени выполнения каждого шага операции.
// Применяется ко всем операциям, когда IPC в медицинском модуле является хирургом.
...
/datum/surgery_operation/get_surgeon_surgery_speed_mod(mob/living/patient, mob/living/surgeon, tool)
	...
	if(HAS_TRAIT(surgeon, TRAIT_MEDICAL_ACES))
		. *= 0.75  // На 25% быстрее каждый шаг операции
