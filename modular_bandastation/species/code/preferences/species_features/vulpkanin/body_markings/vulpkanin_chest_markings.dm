/datum/preference/choiced/vulpkanin_chest_markings
...
/datum/preference/choiced/vulpkanin_chest_markings/init_possible_values()
	return assoc_to_keys_features(SSaccessories.vulpkanin_chest_markings_list)

/datum/preference/choiced/vulpkanin_chest_markings/icon_for(value)
	...
	if(value != SPRITE_ACCESSORY_NONE)
		var/datum/sprite_accessory/markings = SSaccessories.vulpkanin_chest_markings_list[value]
...
/datum/preference/choiced/vulpkanin_chest_markings/apply_to_human(mob/living/carbon/human/target, value)
	target.dna.features["vulpkanin_chest_markings"] = value

/datum/preference/choiced/vulpkanin_chest_markings/compile_constant_data()
	var/list/data = ..()
