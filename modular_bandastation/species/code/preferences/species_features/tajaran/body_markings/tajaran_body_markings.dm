/datum/preference/choiced/tajaran_body_markings
	...
	relevant_body_markings = /datum/bodypart_overlay/simple/body_marking/tajaran_body
...
/datum/preference/choiced/tajaran_body_markings/icon_for(value)
	...
	if(value != SPRITE_ACCESSORY_NONE)
		var/datum/sprite_accessory/body_markings = SSaccessories.tajaran_body_markings_list[value]
		for(var/obj/item/bodypart/body_part_type as anything in body_part_types)
