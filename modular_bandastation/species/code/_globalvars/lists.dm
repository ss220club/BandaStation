...
GLOBAL_LIST_INIT(first_names_female_kidan, world.file2list("strings/names/kidan_female.txt"))
GLOBAL_LIST_INIT(first_names_male_kidan, world.file2list("strings/names/kidan_male.txt"))
