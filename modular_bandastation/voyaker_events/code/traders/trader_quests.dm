...
/datum/trader_quest/samopal_medal
	...
	context = "Цель: Найти любую медаль и принести Самопалу."
	reward_money = 500
	reward_rep = 5
...
/datum/trader_quest/fashion_jacket
	...
	context = "Цель: Найти кожанную куртку Фейшна. Она была потеряна на одной из северных дорог Побережья."
	reward_money = 250
	reward_rep = 5
	can_complete(mob/living/carbon/human/H, obj/item/I)
