...
- **Имена:** Если в PR добавляется новый предмет (/obj/item, /obj/structure, /obj/vehicle, /mob/living), его имя обязательно должно быть на английском, а сам перевод делаться через файл `ru_names.toml`.
