...
if command -v rg >/dev/null 2>&1; then
	...
	code_files="modular_bandastation/**/**.dm"
	map_files="_maps/**/**.dmm"
	shuttle_map_files="_maps/shuttles/**.dmm"
	code_x_515="modular_bandastation/**/!(__byond_version_compat).dm"
else
	pcre2_support=0
	grep=grep
	code_files="-r --include=modular_bandastation/**/**.dm"
	map_files="-r --include=_maps/**/**.dmm"
	shuttle_map_files="-r --include=_maps/shuttles/**.dmm"
	code_x_515="-r --include=modular_bandastation/**/!(__byond_version_compat).dm"
fi
